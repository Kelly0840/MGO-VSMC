...
# Old data
# 2.1 Duplicating dfs
avg_old_Col1_df_3 <- avg_old_Col1_dataframe[ , ]
avg_old_Col3_df_3 <- avg_old_Col3_dataframe[ , ]


# 2.2 Calculating RQ
# Old Col1
# 2.2.1 Find average of No MGO values
no_mgo_avg_old_Col1 <- mean(avg_old_Col1_df_3[1:4,5], na.rm = TRUE)
# 2.2.2 Repeat this mean value in a column for non-paired normalisation
avg_old_Col1_df_3$Mean.No.MGO.CT.Col1 <- rep(no_mgo_avg_old_Col1, length.out = nrow(avg_old_Col1_df_3))
# 2.2.3 Calculating Delta Delta CT
avg_old_Col1_df_3$Delta.Delta.CT.Old.Col1 <- avg_old_Col1_df_3[ , 5] - avg_old_Col1_df_3[ ,6]
# 2.2.4 Calculating RQ
avg_old_Col1_df_3$RQ.Old.Col1.3 <- 2^(-avg_old_Col1_df_3$Delta.Delta.CT.Old.Col1)

# Old Col3
# 2.2.1 Find average of No MGO values
no_mgo_avg_old_Col3 <- mean(avg_old_Col3_df_3[1:4,5], na.rm = TRUE)
# 2.2.2 Repeat this mean value in a column for non-paired normalisation
avg_old_Col3_df_3$Mean.No.MGO.CT.Col3 <- rep(no_mgo_avg_old_Col3, length.out = nrow(avg_old_Col3_df_3))
# 2.2.3 Calculating Delta Delta CT
avg_old_Col3_df_3$Delta.Delta.CT.Old.Col3 <- avg_old_Col3_df_3[ , 5] - avg_old_Col3_df_3[ ,6]
# 2.2.4 Calculating RQ
avg_old_Col3_df_3$RQ.Old.Col3.3 <- 2^(-avg_old_Col3_df_3$Delta.Delta.CT.Old.Col3)
...
# Young data
# 2.1 Duplicating dfs
avg_young_Col1_df_3 <- avg_young_Col1_dataframe[ , ]
avg_young_Col3_df_3 <- avg_young_Col3_dataframe[ , ]


# 2.2 Calculating RQ
# Young Col1
# 2.2.1 Find average of No MGO values
no_mgo_avg_young_Col1 <- mean(avg_young_Col1_df_3[1:4,5], na.rm = TRUE)
# 2.2.2 Repeat this mean value in a column for non-paired normalisation
avg_young_Col1_df_3$Mean.No.MGO.CT.Col1 <- rep(no_mgo_avg_young_Col1, length.out = nrow(avg_young_Col1_df_3))
# 2.2.3 Calculating Delta Delta CT
avg_young_Col1_df_3$Delta.Delta.CT.Young.Col1 <- avg_young_Col1_df_3[ , 5] - avg_young_Col1_df_3[ ,6]
# 2.2.4 Calculating RQ
avg_young_Col1_df_3$RQ.Young.Col1.3 <- 2^(-avg_young_Col1_df_3$Delta.Delta.CT.Young.Col1)

# Young Col3
# 2.2.1 Find average of No MGO values
no_mgo_avg_young_Col3 <- mean(avg_young_Col3_df_3[1:4,5], na.rm = TRUE)
# 2.2.2 Repeat this mean value in a column for non-paired normalisation
avg_young_Col3_df_3$Mean.No.MGO.CT.Col3 <- rep(no_mgo_avg_young_Col3, length.out = nrow(avg_young_Col3_df_3))
# 2.2.3 Calculating Delta Delta CT
avg_young_Col3_df_3$Delta.Delta.CT.Young.Col3 <- avg_young_Col3_df_3[ , 5] - avg_young_Col3_df_3[ ,6]
# 2.2.4 Calculating RQ
avg_young_Col3_df_3$RQ.Young.Col3.3 <- 2^(-avg_young_Col3_df_3$Delta.Delta.CT.Young.Col3)


# 2.3 Add "Age" column
#Old Col1
avg_old_Col1_df_3$Age <- c("Old")
avg_old_Col1_df_3 <- avg_old_Col1_df_3[ ,c("Sample.Name", "Sample.Number", "Group", "Age", "Average.C_", "Normalised.old.Col1", "Mean.No.MGO.CT.Col1",
                                           "Delta.Delta.CT.Old.Col1", "RQ.Old.Col1.3")]
#Old Col3
avg_old_Col3_df_3$Age <- c("Old")
avg_old_Col3_df_3 <- avg_old_Col3_df_3[ ,c("Sample.Name", "Sample.Number", "Group", "Age", "Average.C_", "Normalised.old.Col3", "Mean.No.MGO.CT.Col3",
                                         "Delta.Delta.CT.Old.Col3", "RQ.Old.Col3.3")]
#Young Col1
avg_young_Col1_df_3$Age <- c("Young")
avg_young_Col1_df_3 <- avg_young_Col1_df_3[ ,c("Sample.Name", "Sample.Number", "Group", "Age", "Average.C_", "Normalised.young.Col1", "Mean.No.MGO.CT.Col1",
                                               "Delta.Delta.CT.Young.Col1", "RQ.Young.Col1.3")]
#Young Col3
avg_young_Col3_df_3$Age <- c("Young")
avg_young_Col3_df_3 <- avg_young_Col3_df_3[ ,c("Sample.Name", "Sample.Number", "Group", "Age", "Average.C_", "Normalised.young.Col3", "Mean.No.MGO.CT.Col3",
                                             "Delta.Delta.CT.Young.Col3", "RQ.Young.Col3.3")]


# 2.4 Combine old and young data frames

# 2.4.1 Renaming columns so they are the same in young and old, allow for rbind()
Col1_df3_colnames <-c("Sample.Name", "Sample.Number", "Group", "Age", "Average.C_", "Normalised.Col1", "Mean.No.MGO.CT.Col1",
                      "Delta.Delta.CT.Col1", "RQ.Col1")
Col3_df3_colnames <-c("Sample.Name", "Sample.Number", "Group", "Age", "Average.C_", "Normalised.Col3", "Mean.No.MGO.CT.Col3",
                     "Delta.Delta.CT.Col3", "RQ.Col3")
# 2.4.2 Apply colnames to dfs
colnames(avg_old_Col1_df_3) <- Col1_df3_colnames
colnames(avg_young_Col1_df_3) <- Col1_df3_colnames
colnames(avg_old_Col3_df_3) <- Col3_df3_colnames
colnames(avg_young_Col3_df_3) <- Col3_df3_colnames
# 2.4.3 Combine dataframes
old_young_Col1_df <- rbind(avg_young_Col1_df_3,avg_old_Col1_df_3)
old_young_Col3_df <- rbind(avg_young_Col3_df_3,avg_old_Col3_df_3)
...
RQ_old_Col1 <- data.frame(Group = as.integer(names(avg_values)), delta.CT.old.Col1 = as.vector(avg_values))
# 3.2.4 Add column for labels
RQ_old_Col1$Sample <- c("No MGO", "1μM", "10μM", "100μM")
# 3.2.5 Rearrange columns
RQ_old_Col1 <- RQ_old_Col1[ , c("Sample", "Group", "delta.CT.old.Col1")]
# 3.2.6 Add column for delta delta CT
RQ_old_Col1$delta.delta.CT.old.Col1 <- RQ_old_Col1$delta.CT.old.Col1 - RQ_old_Col1[1, 3]
# 3.2.7 Rearrange columns
RQ_old_Col1 <- RQ_old_Col1[ , c("Sample", "Group", "delta.CT.old.Col1", "delta.delta.CT.old.Col1")]
# 3.2.8 Add column for RQ
RQ_old_Col1$RQ.Old.Col1 <- 2^(-RQ_old_Col1$delta.delta.CT.old.Col1)
...
RQ_old_Col3 <- data.frame(Group = as.integer(names(avg_values)), delta.CT.old.Col3 = as.vector(avg_values))
# 3.3.4 Add column for labels
RQ_old_Col3$Sample <- c("No MGO", "1μM", "10μM", "100μM")
# 3.3.5 Rearrange columns
RQ_old_Col3 <- RQ_old_Col3[ , c("Sample", "Group", "delta.CT.old.Col3")]
# 3.3.6 Add column for delta delta CT
RQ_old_Col3$delta.delta.CT.old.Col3 <- RQ_old_Col3$delta.CT.old.Col3 - RQ_old_Col3[1, 3]
# 3.3.7 Rearrange columns
RQ_old_Col3 <- RQ_old_Col3[ , c("Sample", "Group", "delta.CT.old.Col3", "delta.delta.CT.old.Col3")]
# 3.3.8 Add column for RQ
RQ_old_Col3$RQ.Old.Col3 <- 2^(-RQ_old_Col3$delta.delta.CT.old.Col3)
...
RQ_young_Col1 <- data.frame(Group = as.integer(names(avg_values)), delta.CT.young.Col1 = as.vector(avg_values))
# 3.5.4 Add column for labels
RQ_young_Col1$Sample <- c("No MGO", "1μM", "10μM", "100μM")
# 3.5.5 Rearrange columns
RQ_young_Col1 <- RQ_young_Col1[ , c("Sample", "Group", "delta.CT.young.Col1")]
# 3.5.6 Add column for delta delta CT
RQ_young_Col1$delta.delta.CT.young.Col1 <- RQ_young_Col1$delta.CT.young.Col1 - RQ_young_Col1[1, 3]
# 3.5.7 Rearrange columns
RQ_young_Col1 <- RQ_young_Col1[ , c("Sample", "Group", "delta.CT.young.Col1", "delta.delta.CT.young.Col1")]
# 3.5.8 Add column for RQ
RQ_young_Col1$RQ.Young.Col1 <- 2^(-RQ_young_Col1$delta.delta.CT.young.Col1)
...
RQ_young_Col3 <- data.frame(Group = as.integer(names(avg_values)), delta.CT.young.Col3 = as.vector(avg_values))
# 3.6.4 Add column for labels
RQ_young_Col3$Sample <- c("No MGO", "1μM", "10μM", "100μM")
# 3.6.5 Rearrange columns
RQ_young_Col3 <- RQ_young_Col3[ , c("Sample", "Group", "delta.CT.young.Col3")]
# 3.6.6 Add column for delta delta CT
RQ_young_Col3$delta.delta.CT.young.Col3 <- RQ_young_Col3$delta.CT.young.Col3 - RQ_young_Col3[1, 3]
# 3.6.7 Rearrange columns
RQ_young_Col3 <- RQ_young_Col3[ , c("Sample", "Group", "delta.CT.young.Col3", "delta.delta.CT.young.Col3")]
# 3.6.8 Add column for RQ
RQ_young_Col3$RQ.Young.Col3 <- 2^(-RQ_young_Col3$delta.delta.CT.young.Col3)
...
# 4.1 Add "Age" columns
# Old Col1
RQ_old_Col1$Age <- c("Old")
RQ_old_Col1 <- RQ_old_Col1[ ,c("Sample", "Group", "Age", "delta.CT.old.Col1", "delta.delta.CT.old.Col1", "RQ.Old.Col1")]
# Old Col3
RQ_old_Col3$Age <- c("Old")
RQ_old_Col3 <- RQ_old_Col3[ ,c("Sample", "Group", "Age", "delta.CT.old.Col3", "delta.delta.CT.old.Col3", "RQ.Old.Col3")]
# Young Col1
RQ_young_Col1$Age <- c("Young")
RQ_young_Col1 <- RQ_young_Col1[ ,c("Sample", "Group", "Age", "delta.CT.young.Col1", "delta.delta.CT.young.Col1", "RQ.Young.Col1")]
# Young Col3
RQ_young_Col3$Age <- c("Young")
RQ_young_Col3 <- RQ_young_Col3[ ,c("Sample", "Group", "Age", "delta.CT.young.Col3", "delta.delta.CT.young.Col3", "RQ.Young.Col3")]
...
colnames(RQ_old_Col1) <- Col1_meanRQ_colnames
colnames(RQ_young_Col1) <- Col1_meanRQ_colnames
colnames(RQ_old_Col3) <- Col3_meanRQ_colnames
colnames(RQ_young_Col3) <- Col3_meanRQ_colnames


#4.4 Combine dataframes
Mean_RQ_Col1 <- rbind(RQ_young_Col1,RQ_old_Col1)
Mean_RQ_Col3 <- rbind(RQ_young_Col3,RQ_old_Col3)
...
# 5.1 Col1
summary_stats <- old_young_Col1_df %>%
...
old_young_Col1_df$Sample.Name <- factor(old_young_Col1_df$Sample.Name, levels = levels_order)
summary_stats$Sample.Name <- factor(summary_stats$Sample.Name, levels = levels_order)
Mean_RQ_Col1$Sample <- factor(Mean_RQ_Col1$Sample, levels = levels_order)

Col1_bsplot <- ggplot(old_young_Col1_df, aes(x = Sample.Name, y = RQ.Col1, colour = Age)) +
  ...
  labs(title = "Effect of MGO Concentration on COL1A1 Expression",
       x = "MGO Concentration", y = "RQ")


# 5.2 Col3
summary_stats <- old_young_Col3_df %>%
  group_by(Sample.Name, Age) %>%
  summarise(
...
levels_order <- c("No MGO", "1μM", "10μM", "100μM")
old_young_Col3_df$Sample.Name <- factor(old_young_Col3_df$Sample.Name, levels = levels_order)
summary_stats$Sample.Name <- factor(summary_stats$Sample.Name, levels = levels_order)
Mean_RQ_Col3$Sample <- factor(Mean_RQ_Col3$Sample, levels = levels_order)

Col3_bsplot <- ggplot(old_young_Col3_df, aes(x = Sample.Name, y = RQ.Col3, colour = Age)) +
  geom_beeswarm(size = 2, cex = 3, dodge.width = 0.6) +
  geom_errorbar(data = summary_stats, inherit.aes = FALSE,
                aes(x = Sample.Name, ymin = mean_RQ - se, ymax = mean_RQ + se, colour = Age),
                width = 0.2, size = 0.7,
                position = position_dodge(width = 0.6)) +
  geom_point(data = Mean_RQ_Col3,
  ...
  labs(title = "Effect of MGO Concentration on COL3A1 Expression",
       x = "MGO Concentration", y = "RQ")
...
# 6.1 Col1
# 6.1.1 Run analysis
Col1_two_way_ANOVA <- aov(data = old_young_Col1_df, Normalised.Col1 ~ Age * Sample.Name)
# 6.1.2 View ANOVA table
summary(Col1_two_way_ANOVA)
# 6.1.3 Convert to dataframe
Col1_two_way_ANOVA_df <- as.data.frame(summary(Col1_two_way_ANOVA)[[1]])

# 6.2 Col3
# 6.2.1 Run analysis
Col3_two_way_ANOVA <- aov(data = old_young_Col3_df, Normalised.Col3 ~ Age * Sample.Name)
# 6.2.2 View ANOVA table
summary(Col3_two_way_ANOVA)
# 6.2.3 Convert to dataframe
Col3_two_way_ANOVA_df <- as.data.frame(summary(Col3_two_way_ANOVA)[[1]])
...
Tukey_results_Col1 <- TukeyHSD(Col1_two_way_ANOVA)

# 7.1.2 Extract interaction term results and convert to dataframe, adding "comparison" column
Tukey_results_Col1_df <- as.data.frame(Tukey_results_Col1$`Age:Sample.Name`) %>%
...
p_Col1_matrix <- matrix(NA, nrow = length(group_order), ncol = length(group_order),
                        dimnames = list(group_order, group_order))

# 7.1.5 P values in lower diagonal
for (i in seq_len(nrow(Tukey_results_Col1_df))) {
  comps <- unlist(strsplit(Tukey_results_Col1_df$Comparison[i], "-"))
  ...
  if (all(comps %in% group_order)) {
    ...
    if (!is.na(idx1) && !is.na(idx2) && idx1 != idx2) {
      lower <- max(idx1, idx2)
      upper <- min(idx1, idx2)
      p_Col1_matrix[lower, upper] <- sprintf('%.5f', Tukey_results_Col1_df$`p adj`[i])
    }
  }
}
...
p_Col1_table <- as.data.frame(p_Col1_matrix)
print(p_Col1_table, na.print = "")


# 7.2 Col3
# 7.2.1 Run Tukey HSD post hoc test on two-way ANOVA results
Tukey_results_Col3 <- TukeyHSD(Col3_two_way_ANOVA)

# 7.2.2 Extract interaction term results and convert to dataframe, adding "comparison" column
Tukey_results_Col3_df <- as.data.frame(Tukey_results_Col3$`Age:Sample.Name`) %>%
  tibble::rownames_to_column("Comparison")
...
p_Col3_matrix <- matrix(NA, nrow = length(group_order), ncol = length(group_order),
                       dimnames = list(group_order, group_order))

# 7.2.5 P values in lower diagonal
for (i in seq_len(nrow(Tukey_results_Col3_df))) {
  comps <- unlist(strsplit(Tukey_results_Col3_df$Comparison[i], "-"))
  ...
  if (all(comps %in% group_order)) {
    ...
    if (!is.na(idx1) && !is.na(idx2) && idx1 != idx2) {
      lower <- max(idx1, idx2)
      upper <- min(idx1, idx2)
      p_Col3_matrix[lower, upper] <- sprintf('%.5f', Tukey_results_Col3_df$`p adj`[i])
    }
  }
}
...
p_Col3_table <- as.data.frame(p_Col3_matrix)
print(p_Col3_table, na.print = "")
...
# Col1
ggsave("Col1_bsplot_small.pdf", plot = Col1_bsplot, width = 21, height = 13, units = "cm")
ggsave("Col1_bsplot_big.pdf", plot = Col1_bsplot, width = 32, height = 18, units = "cm")
# Col3
ggsave("Col3_bsplot_small.pdf", plot = Col3_bsplot, width = 21, height = 13, units = "cm")
ggsave("Col3_bsplot_big.pdf", plot = Col3_bsplot, width = 32, height = 18, units = "cm")


# 8.2 Saving Tukey results

# 8.2.2 Creating new workbook
Collagen_wb_Col1_Col3 <- createWorkbook()

# 8.2.3 Processing workbook data
process_and_write_table(Collagen_wb_Col1_Col3, "Col1", p_Col1_table)
process_and_write_table(Collagen_wb_Col1_Col3, "Col3", p_Col3_table)

# 8.2.4 Saving workbook
saveWorkbook(Collagen_wb_Col1_Col3, file = "Tukey_Table_Col1_Col3.xlsx", overwrite = TRUE)
